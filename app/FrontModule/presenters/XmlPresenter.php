...
class XmlPresenter extends BasePresenter
{
	...
	public function actionSitemap(){
		$pages = $this->pageManager->getForSitemap();
		$this->template->pages = $pages;
		
		$categories1 = $this->categoryManager->getActive(1);
		$this->template->categories1 = $categories1;
		$categories2 = $this->categoryManager->getActive(2);
